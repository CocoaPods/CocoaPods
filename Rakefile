        ...
        Dir.chdir(dir) do
          ...
          workspace.schemes.each do |scheme_name, project_path|
            ...
            when :ios
              ...
              execute_command "xcodebuild -workspace '#{workspace_path}' -scheme '#{scheme_name}' clean build #{test_flag} ONLY_ACTIVE_ARCH=NO -destination 'platform=iOS Simulator,name=iPhone 6'"
            else
