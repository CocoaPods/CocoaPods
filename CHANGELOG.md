...
* `pod lib create` is now using the `configure` file instead of the `_CONFIGURE.rb` file	[Orta Therox](https://github.com/orta)			[Piet Brauer](https://github.com/pietbrauer)	[#1990](https://github.com/CocoaPods/CocoaPods/pull/1990)
