        ...
        class PodTargetIntegrator
          describe 'In general' do
            ...
            describe '#integrate!' do
              ...
              it '*does* integrate test native targets with resources script phase if built statically' do
                ...
                @test_native_target.build_phases[0].shell_script.should == "\"${PODS_ROOT}/Target Support Files/CoconutLib/CoconutLib-Unit-Tests-resources.sh\"\n"
              ...
              it 'does not integrates test native targets with resources script phase if built dynamically' do
