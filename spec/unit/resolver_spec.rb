  ...
  describe Resolver do
    ...
    describe 'Resolution' do
      ...
      it 'raises an informative error when version conflict is caused by platform incompatibilities for local pods' do
        ...
        local_spec = Specification.from_hash({ 'name' => 'LocalPod', 'version' => '1.0', 'platforms' => { 'ios' => '8.0' } }) # rubocop:disable Style/BracesAroundHashParameters
 ...
 * not added the source repo that hosts the Podspec to your Podfile.
    ...
    describe 'Pre-release versions' do
      ...
      it 'resolves when there is no prerelease dependency on an external source pod' do
        sandbox = config.sandbox
        local_pod = Specification.from_hash({ 'name' => 'LocalPod', 'version' => '1.0.0.LOCAL' }) # rubocop:disable Style/BracesAroundHashParameters
        local_pod2 = Specification.from_hash({ 'name' => 'LocalPod2', 'version' => '1.0.0.LOCAL', 'dependencies' => { 'LocalPod' => [] } }) # rubocop:disable Style/BracesAroundHashParameters
