Pod::Spec.new do |s|
  ...
  s.test_spec 'UnitTests5' do |test_spec|
    test_spec.requires_app_host = true
    test_spec.app_host_name = 'HostedTestLib/AppWithDep'
    test_spec.dependency 'HostedTestLib/AppWithDep'

    test_spec.source_files = 'UnitTests4/**/*'
  end

  s.test_spec 'UnitTests6' do |test_spec|
    test_spec.requires_app_host = true
    test_spec.app_host_name = 'HostedTestLib/AppWithDep'
    test_spec.dependency 'HostedTestLib/AppWithDep'
    test_spec.dependency 'DepPod'
  ...
  s.app_spec 'AppWithDep' do |app_spec|
    app_spec.source_files = 'App/**/*'
