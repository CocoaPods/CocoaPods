module Pod
  ...
  class PodTarget < Target
    ...
    def header_search_paths(include_test_dependent_targets = false)
      ...
      dependent_targets += test_dependent_targets if include_test_dependent_targets
      dependent_targets.each do |dependent_target|
        header_search_paths.concat(sandbox.public_headers.search_paths(platform, dependent_target))
      end
